...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('anore_payment_id', sa.String(64), unique=True, nullable=True, index=True),
    ...
    op.create_index('ix_anore_payments_id', 'anore_payments', ['id'])


def downgrade() -> None:
    op.drop_table('anore_payments')

...
* **email:** отписку применяет только POST + границы токена ([091e2ee](https://github.com/bypara/remnawave-bedolaga-telegram-bot/commit/091e2ee95fd4709f26b521bbc4a05a750a65eb65))

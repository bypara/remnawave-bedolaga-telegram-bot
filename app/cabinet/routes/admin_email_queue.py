...
async def get_email_queue(
    ...
    return {
        ...
        # Старое поле оставляем для совместимости, а общая готовность учитывает
        # и SMTP, и HTTP-провайдеры вроде Resend.
        'smtp_configured': settings.is_smtp_configured(),
        'email_configured': settings.is_email_delivery_configured(),

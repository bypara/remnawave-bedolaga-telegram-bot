"""Handler for Anore balance top-up."""
...
async def _create_anore_payment_and_respond(
    message_or_callback,
    db_user: User,
    db: AsyncSession,
    amount_kopeks: int,
    ...
    logger.info('Anore payment created', telegram_id=db_user.telegram_id, amount_rub=amount_rub)


@error_handler
async def process_anore_payment_amount(
    ...
    await _create_anore_payment_and_respond(
...
@error_handler
async def process_anore_custom_amount(
    message: types.Message,
    db_user: User,
    db: AsyncSession,
    state: FSMContext,
    ...
    await process_anore_payment_amount(
        message=message,
        db_user=db_user,
        db=db,
        amount_kopeks=amount_kopeks,

...
def test_subscription_copy_uses_requested_custom_emoji():
    ...
    expected = {
        ...
        'TARIFF_SWITCH_CURRENT_LINE': '5260726538302660868',
        'TARIFF_SWITCH_DAYS_LEFT_LINE': '5258258882022612173',
        ...
        'TARIFF_SWITCH_DOWNGRADE_PREVIEW': '5406745015365943482',
...
def test_subscription_copy_renders_dynamic_values_in_both_languages():
    samples = {
        ...
        'TARIFF_SWITCH_CURRENT_LINE': {'name': 'Minimum'},
        'TARIFF_SWITCH_DAYS_LEFT_LINE': {'days': 233},
        'TARIFF_SWITCH_UPGRADE_PREVIEW': {
            'current': 'Minimum',
            'current_traffic': '100 GB',
            'current_devices': 1,
            'name': 'Standard',
            'traffic': '499 GB',
            'devices': 5,
